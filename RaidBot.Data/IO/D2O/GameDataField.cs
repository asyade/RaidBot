...
namespace RaidBot.Data.IO.D2O
{
    public class GameDataField
    {
        ...
        public void SetClasses(Dictionary<int, GameDataClassDefiniton> Classes, string I18n)
        {  
            i18nAcessor = I18n;
            classes = Classes;
        }
        ...
        private object ReadObject(string className, BigEndianReader stream, uint dimention)
        {
            ...
            return classes[classId].Read(stream, i18nAcessor);
        }
