...
namespace RaidBot.Engine.Utility.Security
{
    public static class Cryptography
    {
        ...
        public static sbyte[] Encrypt(sbyte[] key, string salt, string username, string password)
        {
            ...
            byte[] credentials = SetCredentials(publicKey, validSalt, username, password);
        ...
        private static byte[] SetCredentials(RSACryptoServiceProvider publickey, string salt, string username, string password)
        {
